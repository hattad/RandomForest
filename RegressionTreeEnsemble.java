...
parsedData.mapToPair(new PairFunction<LabeledPoint, Double, Double>() {
...
Double MSE = new JavaDoubleRDD(predictionAndLabel.map(
  ...
  final Double yMean = new JavaDoubleRDD(predictionAndLabel.map(
    new Function<Tuple2<Double, Double>, Object>() {
      public Object call(Tuple2<Double, Double> pair) {
        return pair._2();
      }
  ...
  Double numerator = new JavaDoubleRDD(predictionAndLabel.map(
    new Function<Tuple2<Double, Double>, Object>() {
      public Object call(Tuple2<Double, Double> pair) {
        return Math.pow(pair._1() - pair._2(), 2.0);
      }
  ...
  Double denominator = new JavaDoubleRDD(predictionAndLabel.map(
    new Function<Tuple2<Double, Double>, Object>() {
      public Object call(Tuple2<Double, Double> pair) {
